...
def data_training(result):
    ...
    for i in range(10):
        ...
        if accuracy > max_accuracy:
            ...
            index = i
    print("The Accuracies of Machine Learning Algorithm are as follows: ")
    for i in range(10):
        print(str(mn[i])+ ": " +str(accuracy_list[i]))
    print(max_accuracy)
    print(mn[index])
    ...
    print("The Probability of being diabetic is: " + str(round(predictionProbability[0][1]*100,2)))
